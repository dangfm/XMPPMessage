...
-(void)initViews{
    ...
    if (!self.window) {
        ...
        _navigationController = [[UINavigationController alloc] initWithRootViewController:mainController];
        ...
        if (![CommonOperation getMyJID]) {
            ...
            [mainController presentViewController:nc animated:YES completion:^{
